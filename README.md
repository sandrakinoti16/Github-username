...
Sandra Kinoti
# Description 😄
This is a website that allows users to search for a Github username and repo and get the results of their search.
## BDD ##
...
* git clone ```https://github.com/sandrakinoti16/Github-username```
